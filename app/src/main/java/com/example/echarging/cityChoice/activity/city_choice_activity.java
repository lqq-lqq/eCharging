package com.example.echarging.cityChoice.activity;
...
import com.example.echarging.cityChoice.binding.Bind;
import com.example.echarging.cityChoice.binding.ViewBinder;
import com.example.echarging.cityChoice.model.CityEntity;
import com.example.echarging.cityChoice.utils.JsonReadUtil;
import com.example.echarging.cityChoice.utils.ScreenUtils;
import com.example.echarging.cityChoice.utils.ToastUtils;
import com.example.echarging.cityChoice.view.LetterListView;
...
public class city_choice_activity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    private void initView() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            //int top = ScreenUtils.getSystemBarHeight();  //此语句导致闪退，不知何因
            //top+=1000;
            //  System.out.println("top = "+top);
            //Log.e("tag", "top = "+top);
            mToolbar.setPadding(0, 50, 0, 0);
        }
    ...
    private void initData() {
        ...
        System.out.println("totalCityList="+totalCityList);
        System.out.println("hotCityList="+hotCityList);
        System.out.println("cityListAdapter="+cityListAdapter);

        totalCityLv.setAdapter(cityListAdapter);
        System.out.println("totalCityLv.adapter="+totalCityLv.getAdapter());
        System.out.println("totalCityLv="+totalCityLv);
    ...
    public void initTotalCityList() {
        ...
        //System.out.println("this is cityListJson"+cityListJson);
        //System.out.print(cityListJson);
    ...
    private class CityListAdapter extends BaseAdapter {
        ...
        CityListAdapter(Context context,
            ...
            System.out.println(alphaIndexer);
        }
